...
<body>
  ...
  <section id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container text-right">
      <i class="icofont-phone"></i> +62 813-2686-8227
      <i class="icofont-clock-time icofont-rotate-180"></i>Setiap Hari : 16:00 PM - 00:00 PM
    </div>
  </section>
        ...
        <ul>
          ...
          <li class="nav-item dropright fixed @yield('aktifmenu')">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="{{url('makan')}}" style="color: rgb(255, 123, 0)";>Makanan</a>
              <div role="separator" class="dropdown-divider"></div>
              <a class="dropdown-item" href="{{url('minum')}}" style="color: rgb(255, 123, 0)";>Minuman</a>
            </div>
          </li>
          <li class="@yield('event')"><a href="{{url('event')}}">Events</a></li>
